...
from light_db import insert_data_to_table
...
button_topic = 'pr/home/button_123_BS/sts_light'
button_pub = "pr/home/button_123_BS/sub_light"
CURRENT_STATE = 'OFF'
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc):
        ...
        self.eSub__Topic = QLineEdit()
        self.eSub__Topic.setText("pr/home/button_123_BS/sub_light")
        ...
        formLayot.addRow("Sub topic", self.eSub__Topic)
    ...
    def on_button_connect_click(self):
        ...
        self.mc.subscribe_to("pr/home/button_123_BS/sub_light")

    def push_button_click(self):
        global CURRENT_STATE
        print("inside click button")
        if CURRENT_STATE == 'OFF':
            self.mc.publish_to(button_topic, 'ON')
            CURRENT_STATE = 'ON'
        else:
            self.mc.publish_to(button_topic, 'OFF')
            CURRENT_STATE = 'OFF'

    def send_message_to_relay(self, m_decode):
        splitted = m_decode.split(' ')
        light_threshold = os.environ.get('LIGHT_THRESHOLD', 40)
        if float(splitted[2]) > light_threshold and CURRENT_STATE == 'OFF':
            self.push_button_click()
        elif CURRENT_STATE == 'ON' and float(splitted[2]) <= light_threshold:
            self.push_button_click()
        insert_data_to_table(splitted[2], CURRENT_STATE)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Blinds Button')
