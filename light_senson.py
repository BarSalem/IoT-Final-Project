...
LIGHT_TOPIC = 'pr/home/button_123_BS/sub_light'
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc):
        ...
        self.ePublisherTopic.setText(LIGHT_TOPIC)
        ...
        formLayot.addRow("Light Strength", self.Temperature)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Light Strength Sensor')
    ...
    def update_data(self):
        print('Next update')
        light_strength = random.randrange(1, 100)
        current_data = 'Light Strength: ' + str(light_strength)
        self.connectionDock.Temperature.setText(str(light_strength))
        self.mc.publish_to(LIGHT_TOPIC, current_data)
